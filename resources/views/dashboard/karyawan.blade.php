                                            ...
                                            <div id="modal1" class="modal">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value="" class="form-control" name="karyawan"
                                            ...
                                            @foreach ($karyawan as $k)
                                                <tr>
                                                    ...
                                                    <td class="d-flex justify-content-evenly">
                                                        <a class="btn waves-effect waves-light modal-trigger" style="color: white; background-color: red" href="#modal3 {{ $k->id }}"><i class="fa-solid fa-trash"{{ $k->id }}"></i></a>
                                                        <a class="btn waves-effect waves-light modal-trigger" style="color: white; background-color: skyblue" href="#modal2 {{ $k->id }}" style="color:rgb(56, 72, 124)"><i class="fa-solid fa-pen"></i></a>
                                                    </td>
                                            
                                                    {{-- edit --}}
                                                    <div id="modal2 {{ $k->id }}" class="modal ">
                                                        <div class="modal-content">
                                                            <form action="/lainnya/{{ $k->id }}" method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <h3 style="text-align: center"><b>Ubah Data</b></h3>
                                                                <div class="form-group">
                                                                    <label for="jurusan">Link</label>
                                                                    <input value="{{ $k->link }}" class="form-control" name="link"
                                                    ...
                                                    {{-- delete --}}
                                                    <div id="modal3 {{ $k->id }}" class="modal ">
                                                        <div class="modal-content">
                                                            <form action="/lainnya/{{ $k->id }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
