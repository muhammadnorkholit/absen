                            ...
                            <div class="modal-content">
                                <form action="/ruangan" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="" class="form-control" name="nama_ruangan" id="nama_ruangan"
                                            type="text" placeholder="nama ruangan" />
                                    </div>
                                    <div class="form-group">
                                        <label for="jurusan">No Ruangan :</label>
                                        <input value="" class="form-control" name="no_ruangan" id="nama_ruangan"
                                            type="number" placeholder="no ruangan" />
                                    </div>
                                    <div class="form-group">
                                        <label for="jurusan">Teknisi :</label>
                                        <input value="" class="form-control" name="teknisi" id="teknisi"
                                            type="text" placeholder="nama teknisi" />
                                    </div>
                                        ...
                                        <div class="modal-content">
                                            <form action="/ruangan/{{ $r->id }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $r->nama_ruangan }}" class="form-control"
                                                        name="nama_ruangan" id="nama_ruangan" type="text"
                                                        placeholder="" />
                                                </div>
                                                <div class="form-group">
                                                    <label for="jurusan">No Ruangan</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $r->teknisi }}" class="form-control"
                                                        name="teknisi" id="no_ruangan" type="text" placeholder="" />
                                                </div>
                                                <div class="modal-footer">
