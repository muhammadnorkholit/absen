                            ...
                            <div class="card-content">
                                <div class="header d-flex justify-content-between">
                                    <div class="button">
                                        ...
                                        <button type="submit" class="btn btn_primary">Export pdf</button>
                                                ...
                                                <form action="/siswa" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="nisn" value="{{ old('nisn') }}"
                                                            class="form-control" id="password" type="number"
                                                    ...
                                                    <div class="form-group d-flex" style="gap:20px">
                                                        <div class="custom-control custom-radio">
                                                            <label>
                                                                <input class="with-gap" name="kelas" id="kelas1" value="x" type="radio" checked />
                                                                <span for="kelas1">x</span>
                                                            </label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <label>
                                                                <input class="with-gap" name="kelas" id="kelas2" value="xi" type="radio" />
                                                                <span for="kelas2">xi</span>
                                                            </label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <label>
                                                                <input class="with-gap" name="kelas" id="kelas3" value="xii" type="radio" />
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="form-group d-flex" style="gap:20px">
                                                        <div class="custom-control custom-radio">
                                                            <label>
                                                                <input class="with-gap" name="no_kelas" id="no1" value="1" type="radio" checked />
                                                                <span for="no1">1</span>
                                                            </label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <label>
                                                                <input class="with-gap" name="no_kelas" id="no2" value="2" type="radio"  />
                                                                <span for="no2">2</span>
                                                            </label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <label>
                                                                <input class="with-gap" name="no_kelas" id="no3" value="3" type="radio"  />
                                                                <span for="no3">3</span>
                                                            </label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <label>
                                                                <input class="with-gap" name="no_kelas" id="no4" value="4" type="radio"  />
                                                                <span for="no4">4</span>
                                                            </label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <label>
                                                                <input class="with-gap" name="no_kelas" id="no5" value="5" type="radio"  />
                                                                <span for="no5">5</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="modal-content">
                                                             <form action="/siswa" method="POST">
                                                                    ...
                                                                    <div class="form-group d-flex" style="gap:20px">
                                                                        <div class="custom-control custom-radio">
                                                                            <label>
                                                                                <input {{ $s->kelas == 'X' ? 'checked' : '' }} class="with-gap" name="kelas" id="kelas1" value="x" type="radio" />
                                                                                <span for="kelas1">x</span>
                                                                            </label>
                                                                        </div>
                                                                        <div class="custom-control custom-radio">
                                                                            <label>
                                                                                <input {{ $s->kelas == 'XI' ? 'checked' : '' }} class="with-gap" name="kelas" id="kelas2" value="xi" type="radio" />
                                                                                <span for="kelas2">xi</span>
                                                                            </label>
                                                                        </div>
                                                                        <div class="custom-control custom-radio">
                                                                            <label>
                                                                                <input {{ $s->kelas == 'XII' ? 'checked' : '' }} class="with-gap" name="kelas" id="kelas3" value="xii" type="radio" />
                                                                                <span for="kelas3">xii</span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group d-flex" style="gap:20px">
                                                                        <div class="custom-control custom-radio">
                                                                            <label>
                                                                                <input {{ $s->no_kelas == '1' ? 'checked' : '' }} class="with-gap" name="no_kelas" id="no1" value="1" type="radio" checked />
                                                                                <span for="no1">1</span>
                                                                            </label>
                                                                        </div>
                                                                        <div class="custom-control custom-radio">
                                                                            <label>
                                                                                <input {{ $s->no_kelas == '2' ? 'checked' : '' }} class="with-gap" name="no_kelas" id="no2" value="2" type="radio"  />
                                                                                <span for="no2">2</span>
                                                                            </label>
                                                                        </div>
                                                                        <div class="custom-control custom-radio">
                                                                            <label>
                                                                                <input {{ $s->no_kelas == '3' ? 'checked' : '' }} class="with-gap" name="no_kelas" id="no3" value="3" type="radio"  />
                                                                                <span for="no3">3</span>
                                                                            </label>
                                                                        </div>
                                                                        <div class="custom-control custom-radio">
                                                                            <label>
                                                                                <input {{ $s->no_kelas == '4' ? 'checked' : '' }} class="with-gap" name="no_kelas" id="no4" value="4" type="radio"  />
                                                                                <span for="no4">4</span>
                                                                            </label>
                                                                        </div>
                                                                        <div class="custom-control custom-radio">
                                                                            <label>
                                                                                <input {{ $s->no_kelas == '5' ? 'checked' : '' }} class="with-gap" name="no_kelas" id="no5" value="5" type="radio"  />
                                                                                <span for="no5">5</span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
