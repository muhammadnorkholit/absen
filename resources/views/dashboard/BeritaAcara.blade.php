                                            ...
                                            <div class="col s3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control    js-select" name="guru">
                                                        <option value="">Pilih Disini</option>
                                                        @foreach ($guru as $g)
                                                            <option {{old('guru') == $g->id?'selected':''}} value="{{ $g->id }}">    {{ $g->guru }}</option Required>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                    ...
                    <div class="col s12">
                        <div class="card">
                            <div class="card-content" style="text-align: center;">
                                ...
                                <p>Mapel 2 di isi apabila terdapat 2 mapel berbeda di jam yang sama, jika tidak ada tidak perlu di isi</p>
                            </div>
