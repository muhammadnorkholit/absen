                            ...
                            <div class="modal-content">
                                <form action="/guru" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="" class="form-control" name="guru" id="link"
                                            type="text" placeholder="masukkan link" />
                                    </div>
                            ...
                            @foreach ($guru as $g)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-evenly">
                                        <a class="btn waves-effect waves-light modal-trigger red " style="margin-right: 5px"
                                            href="#modal3 {{ $g->id }}"><i
                                                class="fa-solid fa-trash"{{ $g->id }}"></i></a>
                                        <a class="btn waves-effect waves-light modal-trigger green"
                                            href="#modal2 {{ $g->id }}"><i class="fa-solid fa-pen"></i></a>
                                    </td>
                                        ...
                                        <div class="modal-content">
                                            <form action="/guru/{{ $g->id }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $g->guru }}" class="form-control" name="guru"
