...
@endphp
    <section>
        ...
        <div class="body">
            ...
            <div class="content">
                <p>Pada hari ini {{ $dayList[date('D')] }}, pada tanggal {{date('d') }} bulan {{$montList[date('M')]}} tahun {{date('Y')}}.</p>
                ...
                <p>Yang Tidak Hadir : {{$all - $hadir}} Orang, yakni : <br><br>  @foreach($nohadir as $nohad)
                    {{$nohadir ? $nohad->nama .',':''}}
                @endforeach    
                <br><br>
