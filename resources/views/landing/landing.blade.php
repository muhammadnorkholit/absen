            ...
            <ul id="slide-out" class="sidenav">
                <li class="side-wrap">
                    <ul class="collapsible">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="collapsible-header has-arrow two-column"><i class="material-icons">move_to_inbox</i><span class="hide-menu"> Apps </span></a>
                            <div class="collapsible-body">
                                <ul>
                        ...
                        <li class="mega-dropdown">
                            <a href="javascript: void(0);" class="collapsible-header has-arrow"><i class="material-icons">widgets</i><span class="hide-menu"> UI </span></a>
                            <div class="collapsible-body">
                                <ul>
                        ...
                        <li class="multiple">
                            <a class="collapsible-header has-arrow"><i class="material-icons">receipt</i><span class="hide-menu">Forms</span></a>
                            <div class="collapsible-body">
                                <ul class="collapsible" data-collapsible="accordion">
                                    <li>
                                        ...
                                        <div class="collapsible-body second-level">
                                            <ul class="collapsible" data-collapsible="accordion">
                                                <li>
                                                    <a href="form-autocomplete.html">
                                                        <i class="material-icons">format_indent_increase</i>
                                                        <span class="hide-menu">Autocomplete</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-checkboxes.html">
                                                        <i class="material-icons">check_circle</i>
                                                        <span class="hide-menu">Checkboxes</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-chips.html">
                                                        <i class="material-icons">collections_bookmark</i>
                                                        <span class="hide-menu">Chips</span>
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="form-radio-buttons.html">
                                                        <i class="material-icons">album</i>
                                                        <span class="hide-menu">Radio Buttons</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-range.html">
                                                        <i class="material-icons">compare</i>
                                                        <span class="hide-menu">Range</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-select.html">
                                                        <i class="material-icons">check_box</i>
                                                        <span class="hide-menu">Select</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-switch.html">
                                                        <i class="material-icons">confirmation_number</i>
                                                        <span class="hide-menu">Switch</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-text-inputs.html">
                                                        <i class="material-icons">flash_auto</i>
                                                        <span class="hide-menu">Text Input</span>
                                                    </a>
                                                </li>
                                                <li>
                                    ...
                                    <li>
                                        <a class="collapsible-header has-arrow">
                                            ...
                                            <span class="nav-text">Form Pages</span>
                                        </a>
                                        <div class="collapsible-body second-level">
                                            <ul class="collapsible" data-collapsible="accordion">
                                                <li>
                                                    <a href="form-masks.html">
                                                        ...
                                                        <span class="hide-menu">Form Mask & Typehead</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-layouts.html">
                                                        <i class="material-icons">filter_b_and_w</i>
                                                        <span class="hide-menu">Form Layout</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-input-grid.html">
                                                        <i class="material-icons">border_inner</i>
                                                        <span class="hide-menu">Form Input Grid</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-hidden-label.html">
                                                        <i class="material-icons">border_style</i>
                                                        <span class="hide-menu">Form Hidden Label</span>
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="form-bordered.html">
                                                        <i class="material-icons">Form with Border</i>
                                                        <span class="hide-menu">Form with Border</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-row-separator.html">
                                                        <i class="material-icons">chrome_reader_mode</i>
                                                        <span class="hide-menu">Form Row Separator</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-row-striped.html">
                                                        <i class="material-icons">assignment</i>
                                                        <span class="hide-menu">Form Row Striped</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-label-striped.html">
                                                        <i class="material-icons">border_horizontal</i>
                                                        <span class="hide-menu">Form Label Striped</span>
                                                    </a>
                                                </li>
                                                <li>
                                    ...
                                    <li>
                                        <a class="collapsible-header has-arrow">
                                            ...
                                            <span class="nav-text">Form Pickers</span>
                                        </a>
                                        <div class="collapsible-body second-level">
                                            <ul class="collapsible" data-collapsible="accordion">
                                                <li>
                                                    <a href="form-picker-colorpicker.html">
                                                        <i class="material-icons">brightness_4</i>
                                                        <span class="hide-menu">Form Colorpicker</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-picker-datetimepicker.html">
                                    ...
                                    <li>
                                        <a class="collapsible-header has-arrow">
                                            ...
                                            <span class="nav-text">Form Editors</span>
                                        </a>
                                        <div class="collapsible-body second-level">
                                            <ul class="collapsible" data-collapsible="accordion">
                                                <li>
                                                    <a href="form-editor-ckeditor.html">
                                                        ...
                                                        <span class="hide-menu">Form Ckeditor</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="form-editor-tinymce.html">
                                                        <i class="material-icons">brightness_4</i>
                                                        <span class="hide-menu">Form Tinymce</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <li class="multiple">
                            <a class="collapsible-header has-arrow"><i class="material-icons">apps</i><span class="hide-menu">Tables</span></a>
                            <div class="collapsible-body">
                                <ul class="collapsible" data-collapsible="accordion">
                                    <li>
                                    ...
                                    <li>
                                        <a href="table-editable.html">
                                            ...
                                            <span class="hide-menu">Editable Table</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="table-jsgrid.html">
                                            <i class="material-icons">grain</i>
                                            <span class="hide-menu">Jsgrid Table</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="table-footable.html">
                                            <i class="material-icons">gamepad</i>
                                            <span class="hide-menu">Footable Table</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="collapsible-header has-arrow">
                                        ...
                                        <div class="collapsible-body second-level">
                                            <ul class="collapsible" data-collapsible="accordion">
                                                ...
                                                <li>
                                                    <a href="table-datatable-api.html">
                                                        <i class="material-icons">border_outer</i>
                                                        <span class="hide-menu">API</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="table-datatable-advanced.html">
                                                        <i class="material-icons">border_style</i>
                        ...
                        <li class="multiple">
                            <a class="collapsible-header has-arrow"><i class="material-icons">pie_chart</i><span class="hide-menu">Charts</span></a>
                            <div class="collapsible-body">
                                <ul class="collapsible" data-collapsible="accordion">
                                    <li>
                                    ...
                                    <li>
                                        <a href="chart-chartjs.html">
                                            ...
                                            <span class="hide-menu">Chartjs Chart</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="chart-extra-chart.html">
                                            <i class="material-icons">explicit</i>
                                            <span class="hide-menu">Extra Chart</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="chart-flot.html">
                                            <i class="material-icons">insert_chart</i>
                                            <span class="hide-menu">Flot Chart</span>
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="chart-peity.html">
                                            ...
                                            <span class="hide-menu">Peity Chart</span>
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a class="collapsible-header has-arrow">
                                            <i class="material-icons">insert_chart</i>
                                            <span class="nav-text">C3 Charts</span>
                                        </a>
                                        <div class="collapsible-body second-level">
                                            <ul class="collapsible" data-collapsible="accordion">
                                                <li>
                                                    <a href="chart-c3-axis.html">
                                                        <i class="material-icons">pie_chart_outlined</i>
                                                        <span class="hide-menu">Axis Chart</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="chart-c3-bar.html">
                                                        <i class="material-icons">show_chart</i>
                                                        <span class="hide-menu">Bar Chart</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="chart-c3-data.html">
                                                        <i class="material-icons">bubble_chart</i>
                                                        <span class="hide-menu">Data Chart</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="chart-c3-line.html">
                                    ...
                                    <li>
                                        ...
                                        <div class="collapsible-body second-level">
                                            <ul class="collapsible" data-collapsible="accordion">
                                                <li>
                                                    <a href="chart-echart-basic.html">
                                                        <i class="material-icons">trending_up</i>
                                                        <span class="hide-menu"> Basic Chart</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="chart-echart-bar.html">
                                                        <i class="material-icons">signal_cellular_4_bar</i>
                                                        <span class="hide-menu"> Bar Chart</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="chart-echart-pie-doughnut.html">
                        ...
                        <li class="small-cap"><span class="hide-menu">SAMPLE PAGES</span></li>
                        <li class="mega-dropdown">
                            <a href="javascript: void(0);" class="collapsible-header has-arrow"><i class="material-icons">center_focus_strong</i><span class="hide-menu"> Pages </span></a>
                            <div class="collapsible-body">
                                <ul>
                        ...
                        <li class="small-cap"><span class="hide-menu">MULTI DD</span></li>
                        <li class="multiple">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="card-content">
                                ...
                                <div class="message-box">
                                    <div class="message-widget message-scroll">
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="{{asset('assets')}}/images/users/d1.jpg" alt="user" class="circle"> <span class="profile-status online pull-right"></span> </div>
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="{{asset('assets')}}/images/users/d2.jpg" alt="user" class="circle"> <span class="profile-status busy pull-right"></span> </div>
                                            <div class="mail-contnet">
                                                <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                                        </a>
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="{{asset('assets')}}/images/users/4.jpg" alt="user" class="circle"> <span class="profile-status away pull-right"></span> </div>
                                            <div class="mail-contnet">
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="{{asset('assets')}}/images/users/d4.jpg" alt="user" class="circle"> <span class="profile-status offline pull-right"></span> </div>
                                            <div class="mail-contnet">
                                                <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span> </div>
                                        </a>
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="{{asset('assets')}}/images/users/d5.jpg" alt="user" class="circle"> <span class="profile-status online pull-right"></span> </div>
                                            <div class="mail-contnet">
                    ...
                    <div class="col s12 l8">
                        <div class="card news-slide" style="background:url({{asset('assets')}}/images/carousel/img6.jpg) center center / cover;">
                            <div class="carousel carousel-slider" >
                                ...
                                <a class="carousel-item" href="#one!" style="background:url({{asset('assets')}}/images/carousel/img6.jpg) center center / cover;">
                                    <div class="carousel-caption">
                                    ...
                                    <table class="">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="{{asset('assets')}}/images/users/d1.jpg" alt="user" class="circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="{{asset('assets')}}/images/users/d2.jpg" alt="user" class="circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="{{asset('assets')}}/images/users/d3.jpg" alt="user" class="circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="{{asset('assets')}}/images/users/2.jpg" alt="user" class="circle" width="45" /></div>
                                                        <div class="">
                            ...
                            <div class="card-content">
                                ...
                                <div class="comment-widgets scrollable" style="height:560px;">
                                    ...
                                    <div class="d-flex flex-row comment-row">
                                        <div class="p-2"><img src="{{asset('assets')}}/images/users/1.jpg" alt="user" width="50" class="circle"></div>
                                    ...
                                    <!-- Comment Row -->
                                    <div class="d-flex flex-row comment-row">
                                        <div class="p-2"><img src="{{asset('assets')}}/images/users/4.jpg" alt="user" width="50" class="circle"></div>
                                    ...
                                    <!-- Comment Row -->
                                    <div class="d-flex flex-row comment-row">
                                        <div class="p-2"><img src="{{asset('assets')}}/images/users/5.jpg" alt="user" width="50" class="circle"></div>
                                        <div class="comment-text w-100">
                        ...
                        <div id="activity" class="col s12">
                            <div class="m-t-10 p-10">
                                ...
                                <div class="steamline">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="{{asset('assets')}}/images/users/2.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="{{asset('assets')}}/images/users/1.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="{{asset('assets')}}/images/users/4.jpg"> </div>
                                        <div class="sl-right">
                                            <div class="font-medium">Go to the Doctor <span class="sl-date">5 minutes ago</span></div>
                                            <div class="desc">Contrary to popular belief</div>
                                        </div>
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="{{asset('assets')}}/images/users/6.jpg"> </div>
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)">Stephen</a> <span class="sl-date">5 minutes ago</span></div>
                                            <div class="desc">Approve meeting with tiger</div>
                                        </div>
